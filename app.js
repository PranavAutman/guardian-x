// Guardian X Enhanced AI Assistant System with True AI Integration - Fixed Version
class GuardianAIEngine {
    constructor() {
        ...
        // Enhanced pattern matching for fallback
        this.knowledgeBase = {
            capabilities: {
    ...
    async generateResponse(userInput, detectedObjects, missionMode) {
        ...
        try {
            // Attempt real AI API call first
            if (this.apiKey) {
                const aiResponse = await this.callOpenAI(contextualPrompt);
...
// Enhanced Guardian X Assistant System - Fixed Version
class GuardianXAssistant {
    ...
    completeInitialization() {
        ...
        const greeting = "Guardian X AI online. Advanced conversational intelligence active. I can now answer any question, analyze complex scenarios, and engage in natural dialogue while monitoring your environment. My AI systems are ready to assist with anything you need.";
        this.addMessage('assistant', greeting);
        this.speak(greeting);
        
        // Update status ticker
        this.elements.statusTicker.textContent = '🤖 Guardian X AI operational • 🧠 Natural language processing active • 📹 Vision-integrated responses ready';
    }
    ...
    async startCamera() {
        try {
                ...
                this.elements.cameraVideo.addEventListener('loadedmetadata', () => {
                    ...
                    this.elements.cameraVideo.play()
                        .then(() => {
                            ...
                            this.elements.detectionHealth.className = 'health-status ready';
            ...
            this.elements.cameraHealth.className = 'health-status error';
    ...
    stopCamera() {
        if (this.cameraStream) {
            ...
            this.elements.detectionHealth.className = 'health-status standby';
    ...
    async initializeVoiceRecognition() {
        if (!('webkitSpeechRecognition' in window) && !('SpeechRecognition' in window)) {
            ...
            this.elements.voiceHealth.className = 'health-status error';
            return;
        }
        ...
        this.voiceRecognition.onstart = () => {
            ...
            this.elements.voiceHealth.className = 'health-status ready';
        };
    ...
    initPerformanceChart() {
        ...
        this.charts.performance = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    legend: {
                        labels: { color: '#00D4FF', font: { family: 'Courier New' } }
                    }
                },
                scales: {
                    y: {
                        ...
                        ticks: { color: '#00D4FF', font: { family: 'Courier New' } }
                    },
                    x: {
                        grid: { color: 'rgba(255, 255, 255, 0.1)' },
                        ticks: { color: '#00D4FF', font: { family: 'Courier New' } }
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initializing Guardian X');
